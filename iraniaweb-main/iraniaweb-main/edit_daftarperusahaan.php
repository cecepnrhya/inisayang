...
<html lang="en">
  ...
  <div class="container " style="margin-top: 50px;">
      <div class="col form_sign">
        <h3 class="tulisan_signup">Edit Company </h3>
        ...
        <form action="" method="POST">
          ...
          if(isset($_POST['submit'])) {
            if(mysqli_query($conn,"UPDATE daftar_perusahaan SET alamat='$_POST[alamat]',email='$_POST[email]'  WHERE nama_perusahaan='$_POST[nama_perusahaan]' ")) {
