        ...
        <form action="proses_login.php" method="POST">
            <form action="" class="main-form needs-validation" novalidate>
                  <div class="form-group  ">
                      ...
                      <input type="password" name="password" id="password" class="form-control shadow p-3 mb-2 bg-white" id="inputPassword4">
                      <p><a href=forgot.php >Forgot password?</a></p>
                  </div>
                  <div class="col-12">
                      <button type="submit" name="submit" class="btn btn-primary biru-button">Submit</button>
                      <a href="signup.php"><button type="button" name="login" class="btn btn-outline-primary biru-button">Sign Up</button></a>
                  </div>
            </form>
                  <div class="row">
